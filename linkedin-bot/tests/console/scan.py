...
class TestScanFunctions(unittest.TestCase):
    ...
    def test_scank(self: TestScanFunctions, mock_input: Mock):
    ...
    def test_scank_parameter(self: TestScanFunctions, mock_input: Mock, mock_print: Mock):
    ...
    def test_scanWhite(self: TestScanFunctions, mock_scank: Mock, mock_print: Mock):
    ...
    def test_scanWhite_parameter(self: TestScanFunctions, mock_scank: Mock, mock_print: Mock):
    ...
    @patch("builtins.print")
    @patch("console.scan.scank", side_effect=["linkedin", "config", "help", "clear", "theme", "exit", "developer"])
    def test_scanRed(self: TestScanFunctions, mock_scank: Mock, mock_print: Mock):
    ...
    @patch("builtins.print")
    @patch("console.scan.scank", return_value="linkedin")
    def test_scanRed_parameter(self: TestScanFunctions, mock_scank: Mock, mock_print: Mock):
    ...
    @patch("builtins.print")
    @patch("console.scan.scank", side_effect=["linkedin", "config", "help", "clear", "theme", "exit", "developer"])
    def test_scanGreen(self: TestScanFunctions, mock_scank: Mock, mock_print: Mock):
    ...
    @patch("builtins.print")
    @patch("console.scan.scank", return_value="linkedin")
    def test_scanGreen_parameter(self: TestScanFunctions, mock_scank: Mock, mock_print: Mock):
    ...
    @patch("builtins.print")
    @patch("console.scan.scank", side_effect=["linkedin", "config", "help", "clear", "theme", "exit", "developer"])
    def test_scanBlue(self: TestScanFunctions, mock_scank: Mock, mock_print: Mock):
    ...
    @patch("builtins.print")
    @patch("console.scan.scank", return_value="linkedin")
    def test_scanBlue_parameter(self: TestScanFunctions, mock_scank: Mock, mock_print: Mock):
    ...
    @patch("builtins.print")
    @patch("console.scan.scank", side_effect=["linkedin", "config", "help", "clear", "theme", "exit", "developer"])
    def test_scanYellow(self: TestScanFunctions, mock_scank: Mock, mock_print: Mock):
    ...
    @patch("builtins.print")
    @patch("console.scan.scank", return_value="linkedin")
    def test_scanYellow_parameter(self: TestScanFunctions, mock_scank: Mock, mock_print: Mock):
